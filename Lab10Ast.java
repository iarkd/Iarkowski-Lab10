...
public class Lab10Ast extends Applet
{
    ...
    public void paint(Graphics g)
    {
        ...
        flagOfBariya(g);
        flagOfMauritius(g);
        navalSignalDivision(g);
        navalSignalCharlieC(g);
        elstGelderland(g);
        randomPolishStuff(g);
    }
    ...
    public static void flagOfHolland (Graphics g)
    {
        ...
        for (int d = 1; d <= numDots; d++)
        {
            ...
            if (y >= 216 && y < 432)           // middle stripe requires compound condition
                Expo.setColor(g,Expo.white);

            if (y >= 432)                      // right stripe
                Expo.setColor(g,Expo.blue);
    ...
    public static void flagOfBariya(Graphics g)
    {
        ...
        for (int d = 1; d <= numDots; d++)
        {
            ...
            if (y < 250)                       // left stripe
                Expo.setColor(g,Expo.red);

            if (y >= 250 && y < 500)           // middle stripe requires compound condition
                Expo.setColor(g,Expo.white);
            
            if (y >= 500 && y < 750)
                Expo.setColor(g,Expo.red);
                
            if (y >= 750)                      // right stripe
                Expo.setColor(g,Expo.white);
    ...
    public static void navalSignalDivision(Graphics g)
    {
        Expo.setBackground(g,Expo.black);
        for (int d = 1; d <= numDots; d++)
        {
    ...
    public static void navalSignalCharlieC(Graphics g)
    {
        Expo.setBackground(g,Expo.black);
        for (int d = 1; d <= numDots; d++)
        {
    ...
    public static void elstGelderland(Graphics g)
    {
        Expo.setBackground(g,Expo.orange);
        for (int d = 1; d <= numDots; d++)
        {
            int x = Expo.random(0,1000);       // random x value of each dot
            int y = Expo.random(0,650);        // random y value of each dot
    ...
    public static void randomPolishStuff(Graphics g)
    {
        Expo.setBackground(g,Expo.black);
        for (int d = 1; d <= numDots; d++)
        {
